...
const ContactSection = () => {
    return (
        <div
            id="contact"
            className="min-h-[60vh] py-10 relative w-full flex justify-center bg-cover bg-center text-white bg-fixed before:w-full before:h-full before:absolute before:top-0 before:left-0 before:bg-black/80 before:z-10"
            style={{
                backgroundImage:
        ...
        >
            <div className="container text-center relative z-20 flex flex-col space-y-8">
                <div className="flex flex-col space-y-4 justify-center items-center">
                    <span className="text-xs text-textOrange font-semibold tracking-widest capitalize p-font">Rent your car now
                    </span>
                    <button className="text-3xl md:text-4xl font-bold text-textWhite tracking-wide border w-fit px-8 py-2 rounded-2xl cursor-pointer hover:bg-textOrange duration-200 active:scale-95">
                        Book Now
                    </button>
                </div>
                ...
                <p className="mt-6 text-xs md:text-sm text-textWhite/70 tracking-widest font-semibold">
